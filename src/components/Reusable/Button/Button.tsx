...
const Button = ({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={`text-xs md:text-sm rounded-[30px] py-1.5 lg:py-2 pr-2 pl-8 font-Manrope font-medium flex items-center justify-center gap-3 w-fit border h-fit ${className} ${
        variant === "primary"
